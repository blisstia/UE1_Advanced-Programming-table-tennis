# -*- coding: utf-8 -*-
"""
Created on Sat Oct 30 17:04:21 2021
...
frameWidth = 960
frameHeight = 544
cap = cv2.VideoCapture('/Users/tia/Desktop/UE1_projet/dataset/test/videos/test_1.mp4')
cap.set(3, frameWidth)
cap.set(4, frameHeight)
cap.set(10, 80) 
pulse_ms = 30

lower_ball = np.array([80, 30, 160])
upper_ball = np.array([255, 255, 255])

lower_table = np.array([80, 30, 160])
